...
namespace ijw.Next.Maths {
    ...
    /// </summary>
    public class TargetFunctionAdapter : IMisoMathModel {
        /// <summary>
        /// 输入维度. 包装后的维度.
        /// </summary>
        ...
        public TargetFunctionAdapter(IMimoMathModel actualFunction, IEnumerable<int> targetVarableIndexes, IEnumerable<double> fullinput) {
        ...
        /// 
        /// </summary>
        protected IMimoMathModel _model;
        /// <summary>
        /// 
        /// </summary>
